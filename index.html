...
<html lang="en">
  <head>
    ...
    <title>Creative Wallet - Home page</title>
    ...
    <div class="bg-home h-100 pt-2 position-relative">
          ...
          <div class="container">
            ...
            >
              ...
              <ul class="navbar-nav mb-2 mb-md-0">
                ...
                <li class="nav-item">
                  <a
                    class="btn btn-success px-2 ms-lg-3"
                ...
                <li class="nav-item ms-md-2 ms-lg-0 mt-2 mt-md-0">
                  <a
                    class="btn btn-outline-light px-2 ms-lg-3"
                    href="./public/user-page.html"
                    >User page - temp!</a
                  >
                </li>
              </ul>
      ...
      <main class="pb-75">
        <div class="container my-5 w-lg-75 px-2 px-sm-0">
          <div class="shadow p-5 text-center bg-main-home rounded-3">
            <img
              src="./assets/svg/graph-up-arrow.svg"
              alt="graph-up-arrow"
              height="50"
              class="mb-3"
            />
            ...
            <p class="col-lg-8 mx-auto fs-3 py-2">
              <strong>Create an account and see for yourself!</strong>
            </p>
            <p class="col-lg-8 mx-auto fs-5">
              It's simple. Add your incomes and expenses to the app, then check
              the balance from different periods. Categorise the items, add new
              ones, change or delete old ones. Have fun and save money for your
              dreams.
            </p>
          </div>
        </div>
